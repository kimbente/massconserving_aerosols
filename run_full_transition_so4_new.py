...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        model_path = os.path.join("models", f"full_transition_model_so4_epoch_{epoch}.pth")
...
# Export to CSV
results_df.to_csv("convergence/training_metrics_so4.csv", index = False, float_format = "%.4f")

# Append total wall clock time to the end of the file
with open("convergence/training_metrics_so4.csv", "a") as f:
